...
function organization(){
	/* $.get( "organization", function( data ) {
	  $("#pageContentDivId").html( data );
	});
	$(".nav-parent").removeClass("active");
	$("#leftOrgManagementId").addClass("active"); */
...
<div class="leftpanel">
    <div class="leftpanelinner"> 
      ...
      <ul class="nav nav-tabs nav-justified nav-sidebar">
        <li class="tooltips" data-toggle="tooltip" id="mainMenuId" title="Main Menu"><a data-toggle="tab"  data-target="#mainmenu"><i class="tooltips fa fa-ellipsis-h"></i></a></li>
        
        
        <li class="tooltips active" data-toggle="tooltip" title="Settings" id="settingsId"><a data-toggle="tab" data-target="#settings"><i class="fa fa-cog"></i></a></li>
